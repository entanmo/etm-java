...
public class TestData {
    ...
    public static final String secondSecret = "etm111111";
    public static final String userName = "etm_g2";

    public static final String dappId ="dapp1";
    public static final String dappAddress="";
    ...
    public static String publicKey(){
        return EtmSDK.Helper.getPublicKey(secret);
    }
