 ...
 */
public interface Misc extends EtmInterface{
    //查看本地区块链加载状态
    ...
    EtmResult storeData(String content, ContentEncoding encoding, int wait, String secret, String secondSecret);
    ...
    //success	boole	是否成功获得response数据。
    //id	string	交易id
    EtmResult getStoredData(String transactionId);
