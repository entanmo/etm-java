...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            String secondSecret = "etm111111";
            String userName = "etm_g2";

            //String secret2 = "raise cloud royal wonder cradle job gate wife depth device bitter hope";
            //etm_g101	11705168753296944226 00dd0e70fe22e9b580ba0ccf696f1d108a6475bb303b8689947ba346b0b02ad9
            //etm_g96	16093201530526106149 0225c340addf24211f4b51ea24cb0565c67f09600f57bad89af350b38b08a366
            //etm_g32	4354832300657989346 0ae2e3bcd8c959bccc34445a9473eab1bece60300f3aa00d89612923470dee75
            ...
            //etm_g23	4752137788839516181 486179424b4bcfaf7960a4a121277d73e4a7c9e0c27b254edf978762d5a6dfe6
            //etm_g40	16494449392359591122 49b369ff2635e2ac083d62a6c59baf872fbdef6990297f296c95e1830118aba1
...
//            //设置成对应的网络Magic值
//            EtmSDK.Config.setMagic("5f5b3cf5");
//
//
//            //生成10个一级密钥（账户）
//            for( int i=0; i<10; i++) {
...
//
//                System.out.println(String.format("登录成功, publicKey:%s, address:%s, ETM余额：%s", accountPublicKey, accountAddress, balance.toString()));
//            }
//
//            //转账(金额为1ETM)
//            result = EtmSDK.Account.transfer("11705168753296944226",
...
//            result = EtmSDK.Block.getHeight(); /*监控系统产生的当前最新区块信息*/
//            if (result.isSuccessful()){
...
//            }
    ...
    private static boolean handleBlockTransactions(long height){
        EtmResult result = EtmSDK.Block.getBlockByHeight(height, false);
        if (!result.isSuccessful()){
            return false;
        }
        ...
        result = EtmSDK.Transaction.queryTransactions(new TransactionQueryParameters().setBlockId(blockId));
        if (!result.isSuccessful()){
            return false;
        }
        ...
        for (Map<String, Object> trans : transactions) {
            ...
            if (recipientId == "自己平台的地址"){
                ...
                /*
                {
                    ...
                    "type": 0, // 交易类型，0：普通转账
                    "timestamp": 36252686,  // 交易时间戳，Etm时间，可以换算成现实世界的时间
                    ...
                    "amount": 80000000, //转账金额，除以100000000后是真实的ETM个数，这里0.8ETM
                    "fee": 10000000,
