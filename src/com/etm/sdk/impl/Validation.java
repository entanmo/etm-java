...
import com.etm.sdk.dto.query.*;
import com.etm.sdk.security.Bip39;
    ...
    public static boolean isValidAddress(String address){
        return  address != null &&
                ...
                ( address.matches(NUMBER_PATTERN) ||
                        ( address.matches(BASE58_PATTERN) && EtmFactory.getInstance().getSecurity().isValidBase58Address(address))
                );
    }
