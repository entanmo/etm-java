 ...
 * 
 */
public interface Account extends EtmInterface {
    ...
    //请求参数说明：
    //publicKey	string	Y	etm账户公钥
    //返回参数说明：
    //success	boole	是否登陆成功
    //account	json	账户信息
    EtmResult secureLogin(String secret);
    ...
    //version	json	版本相关信息
    EtmResult getAccount(String address);
    ...
    EtmResult getBalance(String address);
    ...
    //success	boole	是否成功获得response数据
    //publicKey	string	公钥*/
    EtmResult getPublicKey(String address);
    ...
    //success	boole	是否成功获得response数据
    //publicKey	string	公钥
    EtmResult generatePublicKey(String secret);
    ...
    EtmResult getVotedDelegates(String address);
    ...
    EtmResult vote( String[] upvotePublicKeys, String[] downvotePublicKeys, String secret, String secondSecret);
    ...
    EtmResult getTopAccounts(QueryParameters parameters);
