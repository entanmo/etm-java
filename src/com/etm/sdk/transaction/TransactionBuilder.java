package com.etm.sdk.transaction;
...
import com.etm.sdk.security.SecurityException;
import com.etm.sdk.security.SecurityStrategy;
import com.etm.sdk.transaction.asset.*;
...
public class TransactionBuilder {
    ...
    public TransactionInfo buildSignature(String secret, String secondSecret) throws  SecurityException{
        ...
        TransactionInfo transaction =  newTransaction(
                ...
                0L,
                EtmConst.Fees.SECOND_SIGNATURE,
                keyPair.getPublic())
    ...
    public TransactionInfo buildInTransfer(String dappId, String currency, long amount, String secret, String secondSecret)throws SecurityException {
        ...
        TransactionInfo transaction =  newTransaction(
                ...
                currency.equals("ETM") ? amount : 0l,
                EtmConst.Fees.TRANSFER,
                keyPair.getPublic())
                .setAsset(new InTransferAssetInfo(dappId, currency,currency.equals("ETM") ? 0l : amount));
