 ...
 */
public interface Dapp extends EtmInterface{
    ...
    EtmResult getBlocksHeight(String dappId);
    ...
    EtmResult getBlocks(String dappId, DappQureyParameters dappQureyParameters);
    ...
    EtmResult getAccount(String dappId,String address);

    //接口地址：/peer/transactions
    //请求方式：POST
    //支持格式：json
    //备注：充值时在主链发生type=6的交易（intransfer），dapp内部会自动调用编号为1的智能合约进行dapp内部充值 请求参数说明：
    EtmResult dappDeposit(String dappId,String currency,long amount,String secret,String secondSecret);
