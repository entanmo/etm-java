 ...
 * @author eagle
 */
public interface UIA extends EtmInterface {
    //获取全网所有发行商
    ...
    //返回参数说明：
    //success	boole	是否成功
    //issuers	list	元素为字典，每个字典代表一个发行商，包含发行商名字、描述、id（Etm地址）
    //count	integer	发行商总个数
    EtmResult getIssuers(int limit, int offset);
    ...
    //返回参数说明：
    //success	boole	是否成功
    //issuers	dict	包含发行商名字、描述、id（Etm地址）
    EtmResult getIssuer(String nameOrAddress);
    ...
    EtmResult queryIssuerAssets(String nameOrAddress, int limit, int offset);
    ...
    EtmResult getAssets(int limit, int offset);
    ...
    EtmResult getAsset(String assertName);
    ...
    EtmResult getAssetACL(String assertName, boolean whiteOrBlack, int limit, int offset);
    ...
    EtmResult getAddressBalances(String address, int limit, int offset);
    ...
    //                        接收者id（系统为空，如资产注册）、交易数量（资产交易都为0）、手续费0.1ETM、签名、多重签名、确认数、
    //                        资产信息（包含发行商id、发行商名字、描述）、交易id。
    //count	integer	资产交易总个数
    EtmResult getTransactions(String ownerPublicKey, int limit, int offset);
    ...
    //返回参数说明：
    //success	boole	是否成功
    EtmResult createIssuer(String name, String desc, String secret, String secondSecret);
    ...
    //返回参数说明：
    //success	boole	是否成功
    EtmResult createAsset(String currency, String desc, long maximum, byte precision, String strategy, String secret, String secondSecret);
    ...
    //返回参数说明：
    //success	boole	是否成功
    EtmResult setAssetACL(String currency, int assertStatus, boolean whiteListMode, String secret, String secondSecret);
    ...
    //返回参数说明：
    //success	boole	是否成功
    EtmResult issue(String currency, long amount, String secret, String secondSecret);
    ...
    //返回参数说明：
    //success	boole	是否成功
    EtmResult transfer(String currency, String recipientId, long amount, String message, String secret, String secondSecret);
    ...
    //返回参数说明：
    //success	boole	是否成功
    EtmResult setAssetStatus(String currency, int assertStatus, boolean whiteListMode, String secret, String secondSecret);
